...
mereka kekal di dalamnya untuk selama-lamanya, (3)''',
  ...
  static const _surahYasinImage = ReadingModel(
    id: 'yasin-image',
    title: 'Surat Yasin (Image)',
    subtitle: 'Yasin dengan tampilan gambar',
    category: 'E-Book',
    icon: Icons.image_rounded,
    arabicText: '',
    latinText: '',
  ...
  static const _manaqibCover = ReadingModel(
    id: 'manaqib-cover',
    title: 'Manaqib Full',
    subtitle: 'Kitab Manaqib Lengkap',
    category: 'Manaqib',
    icon: Icons.auto_stories_rounded,
    arabicText: '',
    latinText: '',
  ...
  static const _yasinFadilah = ReadingModel(
    id: 'yasin-fadilah',
    title: 'Yasin Fadilah',
    subtitle: 'Surat Yasin Fadilah (PDF)',
    category: 'Surat',
    icon: Icons.picture_as_pdf_rounded,
    arabicText: '',
    latinText: '',
    translationText: '',
    pdfPath: 'assets/images/pdf/yasin_fadilah.pdf',
  );
}
